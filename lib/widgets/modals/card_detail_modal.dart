            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isDark ? const Color(0xFF1E1E38) : Colors.grey[200],
                        borderRadius: BorderRadius.circular(14),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Gastado en ciclo', style: GoogleFonts.inter(color: theme.textTheme.bodySmall?.color, fontSize: 11)),
                          const SizedBox(height: 4),
                          Text(currencyFmt.format(totalCycleSpent), style: GoogleFonts.inter(color: theme.textTheme.bodyLarge?.color, fontSize: 16, fontWeight: FontWeight.w700)),
                        ],
                      ),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Días de ciclo', style: GoogleFonts.inter(color: theme.textTheme.bodySmall?.color, fontSize: 11)),
                          const SizedBox(height: 4),
                          Text('$daysRemaining días restantes', style: GoogleFonts.inter(color: theme.colorScheme.primary, fontSize: 14, fontWeight: FontWeight.w700)),
                        ],
                      ),
                    ),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    'Desliza para borrar',
                    style: GoogleFonts.inter(color: theme.textTheme.bodySmall?.color, fontSize: 11),
                  ),
                ],
              ),
                ...
                child: cycleExpenses.isEmpty
                    ? Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.inter(color: theme.textTheme.bodySmall?.color, fontSize: 13),
                        ),
                      )
                    : ListView.builder(
                        shrinkWrap: true,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          DateFormat('dd MMM, HH:mm', 'es_PE').format(exp.fechaConsumo),
                                          style: GoogleFonts.inter(color: theme.textTheme.bodySmall?.color, fontSize: 11),
                                        ),
                                      ],
                                    ),
...
void _showDeleteCardConfirmation(BuildContext context, CreditCard card, WidgetRef ref) {
  showDialog(
    context: context,
    builder: (ctx) => AlertDialog(
      title: const Text('¿Eliminar tarjeta?'),
      content: Text('Se eliminará "${card.banco} ${card.nombreTarjeta}" y todos sus gastos.'),
      actions: [
        TextButton(
